        ...
        <Form className="flex flex-col grow   pt-8 md:max-h-[80vh]">
          ...
          <Box overflowY="auto">
            ...
            >
              ...
              >
                <FormLabel className="helvetica-font font-bold text-lg" color={"#CFCFCF"}>Select date</FormLabel>
                <Field
                  as={Select}
                  id="selectdate"
                  name="selectdate"
              ...
              <Flex
                ...
                pt={{ base: '1.25rem', lg: '0rem' }}
              >
                <FormLabel className="helvetica-font font-bold text-lg" color={"#CFCFCF"}>Select time slot</FormLabel>
                <Field
                  as={Select}
                  id="timeslot"
                  name="timeslot"
