  ...
  <option value="mercedes">CSGO</option>
        ...
        <div className="flex md:flex-row flex-col xl:justify-between justify-center w-full gap-5 mb-8 text-white">
          ...
          <div className="flex flex-col md:py-11 md:px-24 p-7 justify-center place-items-center bg-[#131313] md:w-1/2 w-full">
            ...
            <p className="md:text-lg text-sm font-extrabold mb-8 ppFormula-font italic">
          ...
          <div className="flex flex-col md:py-11 md:px-24 p-7 justify-center place-items-center bg-[#131313] md:w-1/2 w-full ppFormula-font italic ">
            ...
            <p className="md:text-lg text-sm font-extrabold mb-8 md:block hidden  ppFormula-font italic ">
              <em>COLLEGE PLAYOFFS</em>
            </p>
            <div className="md:flex w-full hidden justify-center items-center relative rounded-xl">
              <Image
                width={705}
                height={134}
        ...
        <div className="flex md:flex-row flex-col xl:justify-between justify-center w-full gap-5 mb-8 text-white">
          <div className="flex flex-col py-11 px-8 justify-center items-center md:w-1/2">
            ...
            <button className=" bg-[#DBFD67] md:text-3xl text-xl font-extrabold rounded-lg text-[#333132] md:px-24 px-9 md:py-9 py-6 relative  ppFormula-font italic ">
