            ...
            <div className="flex flex-row flex-wrap justify-center w-full md:gap-8 gap-6 mb-8 text-white">
                ...
                <div className="flex flex-row w-full justify-between md:gap-3 gap-1  place-items-center">
                    ...
                    <div className="flex md:flex-row flex-col gap-4 justify-between md:place-items-center place-items-left w-full md:p-7 py-3 pl-3">
                        <h3 className="md:text-2xl text-lg font-extrabold"><em>FIFA</em></h3>
                        <div className="gradient-border ">
                            <Link href="/rules/fifa" className="inner md:px-1.5rem text-base md:py-1.125rem bg-black px-4 py-2.5 font-medium helvetica-medium-font">
                                VIEW RULEBOOK
                            </Link>
                        </div>
                    </div>
                ...
                <div className="flex flex-row w-full justify-between md:gap-3 gap-1 place-items-center">
                    ...
                    <div className="flex md:flex-row flex-col gap-4 justify-between md:place-items-center place-items-left w-full md:p-7 py-3 pl-3">
                        ...
                        <div className="gradient-border h-fit w-fit">
                            <Link href="/rules/bgmi" className="inner md:px-1.5rem md:py-1.25rem px-4 py-2.5 helvetica-medium-font font-medium bg-black text-base">
                                VIEW RULEBOOK
                            </Link>
                        </div>
                    </div>
                ...
                <div className="flex flex-row w-full justify-between md:gap-3 gap-1 place-items-center">
                    ...
                    <div className="flex md:flex-row flex-col gap-4 justify-between md:place-items-center place-items-left w-full md:p-7 py-3 pl-3">
                        ...
                        <div className="gradient-border h-fit w-fit">
                            <Link href="/rules/valorant" className="inner md:px-1.5rem md:py-1.25rem px-4 py-2.5 helvetica-medium-font font-medium bg-black text-base">
                                VIEW RULEBOOK
                            </Link>
                        </div>
                    </div>
