...
const Footer = () => {
  return (
    <Flex
      className="footer-container flex-col w-full overflow-x-hidden bg-#F0F0F0"
      borderTopRadius="2.5rem"
    >
      <Flex
        className="footer-top-container px-1.5rem lg:px-5rem pt-2rem lg:pt-3.813rem pb-4 lg:pb-2.5rem w-full justify-center lg:justify-between
        items-center flex-col lg:flex-row max-screen-desktop mx-auto"
        borderTopRadius="3.75rem"
      >
        <Heading className="ppFormula-font font-light text-1.75rem lg:text-3.75rem italic">
          LET THE{" "}
        ...
        <Box
          className="helvetica-font text-sm lg:text-base text-white button-style rounded-md flex justify-center items-center
          italic mt-0.937rem lg:mt-1.25rem mb-1.813rem lg:mb-1.25rem h-3.5rem lg:h-4.063rem w-15rem lg:w-29rem bg-pink hover:opacity-80"
        ...
        >
          <Link
            href="/contact-us"
            className="helvetica-font text-sm lg:text-base text-white italic h-full w-full flex justify-center items-center no-underline hover:no-underline"
          >
            GET IN TOUCH
          </Link>
        </Box>
      ...
      >
        ...
        <Flex className="navigation-link-container w-full lg:justify-between px-1.5rem lg:px-5rem max-screen-desktop mx-auto">
          <Flex className="left-link-container flex-col lg:flex-row">
            <Link
              href="/about"
              className="helvetica-font text-12px opacity-65% text-#B4B4B4 hover:text-pink no-underline hover:no-underline"
            >
              ABOUT
            </Link>
            <Link
              href="/schedule"
              className="helvetica-font opacity-65% text-#B4B4B4 hover:text-pink text-12px lg:pl-2rem pt-2rem lg:pt-0 no-underline hover:no-underline"
            >
              SCHEDULE
            </Link>
            <Link
          ...
          <Flex className="right-link-container hidden flex-col lg:flex-row ml-3.688rem lg:ml-0">
            <Link
              href="/rules"
              className="helvetica-font text-12px opacity-65% text-#B4B4B4 hover:text-pink no-underline hover:no-underline"
            >
        ...
        >
          <Flex className="social-icons-container mb-2.5rem lg:mb-0">
            ...
            <Link
              href="https://bit.ly/3rgM7nQ" target="_blank" rel="noopener noreferrer"
            ...
            <Link
              ...
              className="ml-1.25rem lg:ml-1.188rem hover:opacity-70%"
            >
              <Image src="../Insta.svg" alt="insta" className="h-auto w-auto" />
            </Link>
            <Link
