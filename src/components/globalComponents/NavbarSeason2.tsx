    ...
    return(
        ...
        <div className="w-full flex items-center justify-between px-1.25rem py-0.938rem lg:bg-#1A1A1A66 lg:backdrop-blur-md rounded-lg max-w-[1440px]">
          ...
          <div className="w-63.5% items-center justify-between lg:flex hidden ">
            ...
            {
              !state.isLoggedIn ?  <Link href="/register" className="bg-#E7327C  px-1.75rem py-1.125rem rounded-md text-white text-xs helvetica-medium-font">REGISTER NOW</Link> :  <div className="  h-fit w-fit gradient-border">
              <Link href="/my-profile" className="inner bg-[#0F1011] bg-opacity-80 md:px-12 md:py-1.125rem px-12 py-2.5 helvetica-medium-font text-xs  text-#E7327C ">
