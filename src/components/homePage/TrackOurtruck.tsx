...
const TrackOurtruck = () =>{
    ...
    return(
        <div className="flex items-center justify-center w-full md:pt-44 pt-5 bg-black md:pb-60">
        <div className="w-full flex flex-col items-center justify-center max-w-[1440] ">
            ...
            <Image src="/track-our-truck-img.png" alt="track-our-truck" width={1281} height={688} />
