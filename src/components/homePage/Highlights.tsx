  ...
  return (
    <div className="w-full bg-black flex justify-center relative">
      <Image
        width={315}
        height={762}
        src="/assets/high-pink.svg"
        alt=""
        className="absolute top-0 right-0 z-1 md:w-auto w-24"
      />
      <Image
        width={315}
        height={762}
        src="/assets/high-yellow.svg"
        alt=""
        className="absolute left-0 bottom-0 z-1 md:w-auto w-24"
      />
      <div className="max-w-[1440px] w-full h-full relative md:py-28 py-4 justify-center ">
        <div className=" relative md:px-12 px-4 flex flex-col text-3xl w-full font-semibold p-6 place-items-center justify-center md:mb-28 mb-10">
          <Image
            className="max-md:hidden absolute -top-20%"
            src={season}
            width={737}
            height={335}
            alt=""
          ...
          <div className=" p-4 md:w-[60%] fle flex-col justify-center">
            <p className=" w-full text-white text-center md:text-2xl text-lg md:font-normal font-light Montserrat ">
              College Rivals Season 1 crossing across 5 Cities and 25 Colleges,
              saw over 100 million viewers, hundreds of matches played, 92,000+
              participants and 28 Finalists across 6 titles..
              <br></br>
              Packed with epic comebacks and record-breaking performances, it
              set the stage for an even more exciting Season 2.
            </p>
          </div>
        </div>
              ...
              <div key={index} className="p-8">
                <div className="highlight-gradient rounded-xl relative ">
                  <Image
                    ...
                    src={slide.src}
                    alt="highlight"
                    className="mb-4 rounded-xl relative -z-20 md:max-h-[250px] max-h-[140px] md:w-[570px] object-cover"
                  />
                </div>
              </div>
            ))}
