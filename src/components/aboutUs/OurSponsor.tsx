    ...
    return(
        ...
        <div className="max-w-[1440px] w-full h-full flex flex-col justify-center p-12">
            ...
            <div className="flex flex-row flex-wrap justify-around w-full md:gap-20 gap-7 mb-8 text-white z-10">
                <Image width={160} height={37} src="/sponsor1.svg" alt="" className="md:w-auto w-20"/>
                <Image width={138} height={49} src="/sponsor2.svg" alt="" className="md:w-auto w-20"/>
                <Image width={109} height={83} src="/sponsor3.svg" alt="" className="md:w-auto w-20"/>
                <Image width={122} height={45} src="/sponsor4.svg" alt="" className="md:w-auto w-20"/>
                <Image width={133} height={48} src="/sponsor5.svg" alt="" className="md:w-auto w-20"/>
